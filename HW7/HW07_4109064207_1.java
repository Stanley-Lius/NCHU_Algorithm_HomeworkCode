...
public class HW07_4109064207_1 extends Buy_Phone {
	int[][] L;
	int[][] R;
	int[][] temp;
	int[][] ans;
	...
	public static void main(String[] args) {
		HW07_4109064207_1 test = new HW07_4109064207_1();

		int[][] inputArr = { { 1, 1 }, { 2, 4 }, { 2, 10 }, { 5, 4 }, { 4, 8 }, { 5, 5 }, { 8, 4 }, { 10, 2 },
				{ 10, 1 } };
	...
	public int[][] bestPhone(int[][] inputArr) {
		int j, i;
		len = inputArr.length;
		len_minus1 = inputArr.length - 1;
		ans_index = len_minus1;
